...
#
#       The "traditional" style of «sed» and «tr» has been avoided, because
#       they do vary.
#
#       The "ed" and "ex" commands have been avoided too, because their
#       syntax varies noticeably, although the "vi" command is part of POSIX.
#
#   (3) Avoid special characters in file names, passwords and other
#       user-controlled strings used in these scripts.
#
#   (4) Review the main page for this script for advice on
...
if "$cygwin" || "$msys" ; then
    ...
    for arg do
        ...
        # temporary values we need to pass arguments get to here.
